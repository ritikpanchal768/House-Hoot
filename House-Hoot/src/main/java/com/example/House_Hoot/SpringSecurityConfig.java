package com.example.House_Hoot;
...
@Configuration  //Marks this class as a configuration class. This tells Spring that this class contains configurations that will be used to define beans or settings for your application.
@EnableWebSecurity  //This enables Spring Security's web security support. By adding this annotation, Spring Security is activated for your web application, which applies security settings like authentication, authorization, etc.
